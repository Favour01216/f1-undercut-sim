...
const StrategyDashboardContent: React.FC<
  StrategyDashboardContentProps
> = () => {
  // Session management
  ...
  const handleSimulation = useCallback(
    (request: SimulationRequest, response: any) => {
      ...
      <main id="main-content" className="container mx-auto px-4 py-8">
        ...
        <header className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-lg">
            Analyze undercut opportunities with real-time Monte Carlo
            simulations
          </p>
        </header>
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 mt-1">
                  Explore undercut probability across different gaps and tire
                  compounds
                </p>
              </CardHeader>
              <CardContent>
        ...
        <footer className="mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
          <div className="text-center text-gray-500 dark:text-gray-400">
            <p className="mb-2">
              F1 Undercut Simulator • Built with Next.js, FastAPI, and Formula 1
              data
            </p>
            <p className="text-sm">
              For educational and analysis purposes. Real F1 strategy involves
              many more variables.
            </p>
