...
export const GRAND_PRIX_OPTIONS: GrandPrix[] = [
  ...
  { id: "saudi_arabia", name: "Saudi Arabian Grand Prix", country: "🇸🇦" },
  ...
  { id: "imola", name: "Emilia Romagna Grand Prix", country: "🇮🇹" },
  ...
  { id: "silverstone", name: "British Grand Prix", country: "🇬🇧" },
  ...
  { id: "monza", name: "Italian Grand Prix (Monza)", country: "🇮🇹" },
  ...
  { id: "usa", name: "United States Grand Prix", country: "🇺🇸" },
  { id: "mexico", name: "Mexican Grand Prix", country: "🇲🇽" },
  { id: "brazil", name: "Brazilian Grand Prix", country: "🇧🇷" },
  { id: "las_vegas", name: "Las Vegas Grand Prix", country: "🇺🇸" },
  { id: "abu_dhabi", name: "Abu Dhabi Grand Prix", country: "🇦🇪" },
];
...
export const TIRE_COMPOUNDS = [
  {
    ...
    name: "Soft",
    color: "#FF0000",
    description: "Fastest, shortest life",
  },
  {
    id: "MEDIUM",
    name: "Medium",
  ...
  },
  {
    ...
    name: "Hard",
    color: "#FFFFFF",
    description: "Longest life, slowest",
  },
] as const;
