...
class TestInverseUndercut:
    ...
    def test_successful_undercut_small_gap(
        self, mock_gap_calc, mock_get_laps, mock_get_pit_events
    ):
        """
        ...
        fake_laps_df = pd.DataFrame(
            {
                ...
                "stint_lap": [
                    ...
                    9,
                    10,
                ],  # Full stint progression for outlap model
        ...
        fake_pit_events_df = pd.DataFrame(
            {
                "driver_number": [
                    ...
                    44,
                    11,
                ],  # Multiple drivers for better model
        ...
        logger.info("Undercut Simulation Results:")
        ...
        logger.info(
            f"   Avg Degradation: {data['assumptions']['avg_degradation_penalty_s']:.3f}s"
        )
        ...
        assert (
            data["p_undercut"] > 0.44
        ), (  # Threshold reflects marginal scenario reality
    ...
    def test_unsuccessful_undercut_small_gap(
        ...
        logger.info("Small Gap Undercut Results:")
