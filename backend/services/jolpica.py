...
class JolpicaClient:
    ...
    def __init__(self, base_url: Optional[str] = None, cache_dir: Optional[str] = None):
        ...
        """
        self.base_url = base_url or os.getenv("JOLPICA_API_URL", "http://ergast.com/api/f1")
    ...
    def _find_race_round(self, races: List[Dict], gp: str) -> Optional[int]:
        """
        ...
        for race in races:
            ...
            if (gp_lower in race_name or 
                gp_lower in circuit_name or 
                gp_lower in circuit_id or
                race_name in gp_lower or
                circuit_name in gp_lower):
